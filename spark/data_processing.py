...
def load_data(spark):
    ...
    df1 = spark.read.csv("data/202501-citibike-tripdata_1.csv", header=True, inferSchema=True)
    df2 = spark.read.csv("data/202501-citibike-tripdata_2.csv", header=True, inferSchema=True)
    df3 = spark.read.csv("data/202501-citibike-tripdata_3.csv", header=True, inferSchema=True)
    # combine all dfs
